...
const apiRequest = async () => {
  ...
  const updatePage = async () => {
    ...
    const highSugarFruitNames = fruitsArray.map(fruit => fruit.name);
    // TODO: Create a new HTML element to display your data
    const resultElement = document.createElement('p');
  resultElement.textContent = `Names of all fruits: ${highSugarFruitNames.join(', ')}`;
    // TODO: Append your new element to the page
    const resultContainer = document.getElementById('fruitContainer');
    resultContainer.appendChild(resultElement);


    const Calories = fruitsArray.map(fruit => fruit.nutritions.calories);
    // TODO: Create a new HTML element to display your data
    const fornow = document.createElement('p');
  fornow.textContent = `Calories of all fruits: ${Calories.join(', ')}`;
    // TODO: Append your new element to the page
    const resulting = document.getElementById('fruitContainer');
    resulting.appendChild(fornow);
  };
